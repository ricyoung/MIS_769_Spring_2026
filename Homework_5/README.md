...
NER extracts entities from text and classifies them into categories. The diagram below shows the full pipeline including BIO tagging:

![Named Entity Recognition](named_entity_recognition.svg)
